...
export class SolFinanceComponent {
  pageData: ProductPageData = {
    ...
    keyFeatures: {
      ...
      groups: [
        {
          category: 'Billing & Expense',
          icon: 'bi-receipt',
          items: [
            "Invoice Automation: Auto-generate, send, and track invoices with smart payment reminders and real-time status updates.",
            "Expense Management: Capture, categorize, and approve expenses on the go with OCR-powered receipt scanning."
          ]
        },
        {
          ...
          items: [
            "GST Filing & Compliance: Stay fully GST-compliant with automated return filing, reconciliation, and e-invoice generation.",
            "Bank Reconciliation: Automatically match transactions across accounts with smart exception flagging and one-click approvals."
          ]
        },
        {
          ...
          icon: 'bi-graph-up',
          items: [
            "Cash Flow Forecasting: Predict inflows and outflows up to 90 days ahead with ML-driven cash flow models.",
            "Financial Reporting: Generate P&L, balance sheets, and custom dashboards with live data for informed decisions."
          ]
        }
      ]
    },
    workflow: {
      ...
      steps: [
        { title: "GST & TDS Ready", icon: "bi-check-circle", description: "GST-ready and TDS compliant out of the box" },
        { title: "Auto-Match", icon: "bi-check-circle", description: "Real-time bank feeds and auto-reconciliation" },
        { title: "Multi-Currency", icon: "bi-check-circle", description: "Multi-entity and multi-currency support" },
        { title: "Bank-Grade Security", icon: "bi-check-circle", description: "Bank-grade encryption and audit trails" },
        { title: "Instant Reports", icon: "bi-check-circle", description: "One-click financial reports and MIS" },
        { title: "ERP Integrations", icon: "bi-check-circle", description: "Seamless ERP and accounting integrations" }
      ]
    },
    cta: {
