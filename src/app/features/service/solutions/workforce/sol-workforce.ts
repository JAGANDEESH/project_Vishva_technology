...
export class SolWorkforceComponent {
  pageData: ProductPageData = {
    ...
    hero: {
      ...
      imageSrc: 'assets/img/vs%20images/Workspace__process.avif',
      ...
      groups: [
        {
          ...
          icon: 'bi-people',
          items: [
            "Recruitment Pipeline: Source, screen, and onboard talent faster with structured workflows and offer letter automation.",
            "Employee Self-Service: Empower employees to manage their profile, payslips, leaves, and claims from any device."
          ]
        },
        {
          ...
          items: [
            "Payroll Processing: Run accurate, compliant payroll in minutes with automated deductions, TDS, and payslip distribution.",
            "Compliance Tracking: Stay audit-ready with automated statutory compliance, PF, ESI, and labour law monitoring."
          ]
        },
        {
          ...
          icon: 'bi-award',
          items: [
            "Leave Management: Configurable leave policies with self-service applications, manager approvals, and real-time balances.",
            "Performance Reviews: Set OKRs, conduct 360° feedback cycles, and track goals with continuous performance insights."
          ]
        }
      ]
    },
    workflow: {
      ...
      steps: [
        { title: "Full Compliance", icon: "bi-check-circle", description: "Statutory compliance — PF, ESI, TDS, PT" },
        { title: "Auto-Payroll", icon: "bi-check-circle", description: "Automated payslip generation and distribution" },
        { title: "Flexible Policies", icon: "bi-check-circle", description: "Configurable leave and shift policies" },
        { title: "People Analytics", icon: "bi-check-circle", description: "Real-time org chart and headcount analytics" },
        { title: "Audit Trails", icon: "bi-check-circle", description: "Complete audit trail for every HR action" },
        { title: "Mobile ESS", icon: "bi-check-circle", description: "Mobile-first employee self-service portal" }
      ]
    },
    cta: {
