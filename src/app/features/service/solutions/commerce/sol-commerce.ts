...
export class SolCommerceComponent {
  pageData: ProductPageData = {
      ...
      groups: [
        {
          ...
          icon: 'bi-shop',
          items: [
            "Multi-Channel Selling: Sell across web, mobile, marketplaces, and social storefronts from a single unified dashboard.",
            "Product Catalog: Manage thousands of SKUs with bulk uploads, variant configurations, and AI-powered descriptions."
          ]
        },
        {
          ...
          icon: 'bi-box-seam',
          items: [
            "Inventory Management: Real-time stock tracking across warehouses with low-stock alerts and auto-reorder triggers.",
            "Order Processing: Automate order routing, fulfillment, and shipping label generation to eliminate manual steps."
          ]
        },
        {
          ...
          items: [
            "Analytics & Insights: Track sales trends, top products, cart abandonment, and customer lifetime value in real time.",
            "Customer Loyalty: Build retention with points programs, personalized offers, and automated re-engagement campaigns."
          ]
        }
      ]
    },
    workflow: {
      ...
      steps: [
        { title: "Omnichannel Sync", icon: "bi-check-circle", description: "Omnichannel sync across all platforms" },
        { title: "Mobile-First", icon: "bi-check-circle", description: "Mobile-first storefront out of the box" },
        { title: "AI Recommendations", icon: "bi-check-circle", description: "AI-powered product recommendations" },
        { title: "Rapid Go-Live", icon: "bi-check-circle", description: "One-day launch with pre-built templates" },
        { title: "Real-Time Sync", icon: "bi-check-circle", description: "Real-time inventory and order sync" },
        { title: "24/7 Support", icon: "bi-check-circle", description: "24/7 support and dedicated onboarding" }
      ]
    },
    cta: {
