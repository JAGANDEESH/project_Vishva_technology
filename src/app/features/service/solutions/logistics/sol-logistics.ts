...
export class SolLogisticsComponent {
  pageData: ProductPageData = {
    ...
    keyFeatures: {
      ...
      groups: [
        {
          category: 'Tracking & Routing',
          icon: 'bi-geo-alt',
          items: [
            "Shipment Tracking: Live end-to-end shipment visibility with real-time carrier updates and proactive delay alerts.",
            "Route Optimization: AI-driven routing that reduces delivery distance, fuel costs, and time-on-road by up to 35%."
          ]
        },
        {
          ...
          items: [
            "Carrier Management: Integrate with 100+ carriers, compare rates instantly, and auto-assign the best shipping option.",
            "Document Automation: Auto-generate waybills, e-PODs, invoices, and customs documents with zero manual data entry."
          ]
        },
        {
          category: 'Warehouse & Returns',
          icon: 'bi-box-seam',
          items: [
            "Warehouse Operations: Optimize put-away, picking, and packing workflows with barcode scanning and slot management.",
            "Returns Management: Streamline reverse logistics with automated return labels, inspection workflows, and refund triggers."
          ]
        }
      ]
    },
    workflow: {
      ...
      steps: [
        { title: "Omni-Tracking", icon: "bi-check-circle", description: "Real-time tracking across all carriers" },
        { title: "Smart Routing", icon: "bi-check-circle", description: "Multi-carrier rate comparison and auto-select" },
        { title: "ePOD Automation", icon: "bi-check-circle", description: "Automated ePOD and proof of delivery" },
        { title: "AI Optimization", icon: "bi-check-circle", description: "AI-driven route and load optimization" },
        { title: "Freight Auditing", icon: "bi-check-circle", description: "Dispute resolution and freight audit tools" },
        { title: "API Integrations", icon: "bi-check-circle", description: "API-first architecture for any ERP or WMS" }
      ]
    },
    cta: {
